...
const Footer = () => {
    return (
        <div>
            <footer className="px-4 divide-y text-gray-700">
                <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                    <div className="lg:w-1/3">
                        <Link rel="noopener noreferrer" className="flex justify-center space-x-3 lg:justify-start">
                            <div className="flex items-center justify-center w-16 h-12 rounded-full bg-white">
                                <img src="https://3.imimg.com/data3/DV/NR/MY-4264932/education-related-solutions-250x250.png" alt="" />
                            </div>
                            <span className="self-center text-2xl font-semibold">EduCine</span>
                        </Link>
                    </div>
